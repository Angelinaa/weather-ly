...
public class TodayWeather {
    ...
    private String
            week_today3,temperatureH3,temperatureL3,climate3,wind3,week_today4,temperatureH4,temperatureL4,climate4,wind4,week_today5,temperatureH5,temperatureL5,
            climate5,wind5;
